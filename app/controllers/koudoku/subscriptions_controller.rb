module Koudoku
  class SubscriptionsController < ApplicationController
    ...
    def create
      ...
      # if the confirm_prompt is present it
      if @subscription.confirm_prompt
        @subscription.save
        return redirect_to confirm_owner_subscription_path(@owner, @subscription)
      end
    ...
    def subscription_params
      ...
      if defined?(ActionController::StrongParameters)
        params.require(:subscription).permit(:plan_id, :stripe_id, :current_price, :credit_card_token, :card_type, :last_four, :confirm_prompt)
      else
